        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/auth/user/profile/dashboard" className="text-gray-400 hover:text-blue-400 transition-all duration-300 text-sm flex items-center justify-center group">
                  <span className="h-1.5 w-1.5 bg-blue-500 rounded-full mr-2 group-hover:scale-150 transition-transform"></span>
                  Dashboard
                </Link>
              </li>
