...
export default function Home() {
            ...
            if (response.ok) {
                ...
                setMessage(
                    <div className="space-y-1">
                        <div>Your code snippet was saved successfully! View it at:</div>
                        <a
                            href={`/creation/${snippetId}`}
                            className="block underline font-medium hover:text-blue-300 transition-colors break-all"
                        >
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-gray-100 flex flex-col overflow-x-hidden w-full">
                <Header user={user} />

                <main className="flex-grow flex flex-col lg:flex-row relative w-full max-w-full">
                    <div className={`${
                        showEditor ? 'hidden' : 'flex'
                    } lg:flex lg:w-[450px] flex-shrink-0 h-[calc(100vh-64px)] flex-col border-r border-gray-800 w-full max-w-full`}>
                        <div className="p-4 lg:p-6 space-y-6 flex-grow overflow-y-auto overflow-x-hidden">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 w-full">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-gray-800 w-full">
                                    <Dropdown
                                    ...
                                    <button
                                        type="submit"
                                        className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700"
                                    >
                    ...
                    } lg:flex flex-col flex-grow h-[calc(100vh-64px)] w-full`}>
